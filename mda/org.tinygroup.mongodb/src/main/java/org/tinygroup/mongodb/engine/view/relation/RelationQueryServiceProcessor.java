 ...
 * <br>
 */
public class RelationQueryServiceProcessor extends AbstractViewServiceProcessor<PageInfo> {

	
	protected PageInfo serviceProcessor(MongoViewContext serviceProcessor) {
		return serviceProcessor.relationQueryMongoModel();
	}
