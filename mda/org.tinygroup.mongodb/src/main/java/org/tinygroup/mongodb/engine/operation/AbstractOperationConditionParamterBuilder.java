...
/**
 * 
 * 功能说明: 只对条件字段进行参数组装，例如删除操作

 * 开发人员: renhui <br>
 * 开发时间: 2013-11-28 <br>
 * <br>
 */
public class AbstractOperationConditionParamterBuilder extends
	...
	protected Context buildParameter(MongoDBModel model,
		...
		return builder.buildConditionFieldParamter(operation.getConditionFields(), ContextFactory.getContext());
	}
