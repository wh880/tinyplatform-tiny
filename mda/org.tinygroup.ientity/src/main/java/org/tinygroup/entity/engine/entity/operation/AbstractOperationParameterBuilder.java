 ...
 * <br>
 */
public abstract class AbstractOperationParameterBuilder extends
		AbstractEntityModelParameterBuilder {
	...
	protected Context buildParameter(EntityModel model,
		...
		OperationParamterBuilder builder = new OperationParamterBuilder(
				context, model, operation);
		return builder.buildOperationParameter(operation.getOperationGroup(),
