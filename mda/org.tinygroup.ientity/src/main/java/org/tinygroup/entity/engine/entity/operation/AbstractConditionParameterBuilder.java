 ...
 * <br>
 */
public abstract class AbstractConditionParameterBuilder  extends AbstractEntityModelParameterBuilder{

	
	protected Context buildParameter(EntityModel model, ModelRequestInfo modelRequestInfo, Context context) {
		...
		return builder.buildConditionParameter(newContext,operation.getConditionFields());
	}
