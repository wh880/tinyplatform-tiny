...
public class MathCompareRalationProcessor implements ContextProcessor<TinyTemplateParser.Expr_compare_relationalContext> {
    ...
    public Object process(TemplateInterpreter interpreter, TemplateFromContext templateFromContext, TinyTemplateParser.Expr_compare_relationalContext parseTree, TemplateContext pageContext, TemplateContext context, TemplateInterpretEngine engine, Writer writer) throws Exception {
