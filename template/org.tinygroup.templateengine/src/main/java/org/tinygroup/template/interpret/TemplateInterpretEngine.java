 ...
 */
public class TemplateInterpretEngine implements TemplateEngine {
    ...
    public TemplateInterpretEngine setCacheEnabled(boolean cacheEnabled) {
    ...
    public TemplateInterpretEngine(String engineId) {
        this();
        if (engineId != null) {
    ...
    public TemplateInterpretEngine() {
        //添加一个默认的加载器
    ...
    public TemplateInterpretEngine setEncode(String encode) {
        this.encode = encode;
        return this;
    }


    public TemplateInterpretEngine setI18nVisitor(I18nVisitor i18nVistor) {
    ...
    public TemplateInterpretEngine addTemplateFunction(TemplateFunction function) {
    ...
    public TemplateInterpretEngine addResourceLoader(ResourceLoader resourceLoader) {
    ...
    public TemplateInterpretEngine put(String key, Object value) {
