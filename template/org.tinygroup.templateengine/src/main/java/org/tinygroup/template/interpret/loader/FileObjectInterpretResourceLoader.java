 ...
 */
public class FileObjectInterpretResourceLoader extends AbstractResourceLoader<FileObject> {
    ...
    public FileObjectInterpretResourceLoader(String templateExtName, String layoutExtName, String macroLibraryExtName, String root) {
        this(templateExtName, layoutExtName, macroLibraryExtName, VFS.resolveFile(root));
    }

    public FileObjectInterpretResourceLoader(String templateExtName, String layoutExtName, String macroLibraryExtName, FileObject root) {
    ...
    private Template loadTemplate(FileObject fileObject, ClassLoader classLoader) throws TemplateException {
        try {
            Template templateFromContext = TemplateInterpretLoadUtil.loadComponent((TemplateInterpretEngine) getTemplateEngine(), fileObject.getPath(), getResourceContent(fileObject.getPath(),getTemplateEngine().getEncode()));
