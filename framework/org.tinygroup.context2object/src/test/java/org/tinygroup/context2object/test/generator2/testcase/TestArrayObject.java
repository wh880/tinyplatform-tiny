...
public class TestArrayObject extends BaseTestCast2{
	...
	public void testCollection(){
		...
		ObjectContainSimpleObjectArray object = (ObjectContainSimpleObjectArray) generator.getObject(null, null, ObjectContainSimpleObjectArray.class.getName(), this.getClass().getClassLoader(), context);
