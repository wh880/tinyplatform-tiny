...
//		context.put("name", "a");
//		
//		EnumSimpleObjectArray obj = (EnumSimpleObjectArray) generator.getObject(null, null, EnumSimpleObjectArray.class.getName(), this.getClass().getClassLoader(), context);
//		
