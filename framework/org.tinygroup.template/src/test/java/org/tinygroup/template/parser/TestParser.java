...
//        char[] source="${abc.name}".toCharArray();
    ...
    public void testT2_23() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write($writer,U.c($template,$context,U.v($context,\"b\"),\"abc\"));") > 0);
    }
   ...
   public void testT3_30() throws Exception {
    ...
    public void testT30_1() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write($writer,U.c($template,$context,U.v($context,\"aa\"),\"bb\",1,2,U.v($context,\"bb\")));") > 0);
    }
    ...
    public void testT43_1() throws Exception {
        ...
        assertTrue(result.indexOf(" protected void renderContent(TemplateContext $context, Writer $writer) throws IOException, TemplateException{") > 0);
        assertTrue(result.indexOf("write($writer,\"abc \");") > 0);
    }
