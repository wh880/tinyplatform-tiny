...
//        char[] source="${abc.name}".toCharArray();
    ...
    public void testT2() throws Exception {
        ...
        assertTrue(result.indexOf("write(outputStream,\"abc\");") > 0);
    }
    ...
    public void testT2_200() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("$macro.render($template,$context,outputStream);") > 0);
    }
    public void testT2_21() throws Exception {
        String result = execute("$!{abc}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.escapeHtml((U.v($context,\"abc\"))));") > 0);
    }
    public void testT2_22() throws Exception {
        String result = execute("${b?.c}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.sp(U.v($context,\"b\"),\"c\"));") > 0);
    }
    public void testT2_23() throws Exception {
        String result = execute("${b.abc()}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.c($template,U.v($context,\"b\"),\"abc\"));") > 0);
    }
    ...
    public void testT2_10() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"l++\",2));") > 0);
    }

    public void testT2_13() throws Exception {
        String result = execute("${2>>1}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\">>\",2,1));") > 0);
    }
    ...
    public void testT2_15() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,getTemplateEngine().executeFunction(\"abc\",2));") > 0);
    }

    public void testT2_16() throws Exception {
        String result = execute("${aa()}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,getTemplateEngine().executeFunction(\"aa\"));") > 0);
    }

    public void testT2_18() throws Exception {
        String result = execute("${aa(bb(1))}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,getTemplateEngine().executeFunction(\"aa\",getTemplateEngine().executeFunction(\"bb\",1)));") > 0);
    }

    public void testT2_19() throws Exception {
        String result = execute("${abc.aa(bb(1))}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.c($template,U.v($context,\"abc\"),\"aa\",getTemplateEngine().executeFunction(\"bb\",1)));") > 0);
    }
   public void testT2_20() throws Exception {
        String result = execute("${format('this is %s',2)}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,getTemplateEngine().executeFunction(\"format\",\"this is %s\",2));") > 0);
    }

    public void testT2_17() throws Exception {
        String result = execute("$${abc.bb}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.getI18n($template.getTemplateEngine().getI18nVistor(),$context,\"abc.bb\"));") > 0);
    }
    ...
    public void testT2_12() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.a(U.v($context,\"map\"),\"id\"));") > 0);
    }

    public void testT2_1() throws Exception {
        String result = execute("${aa.bb}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.p(U.v($context,\"aa\"),\"bb\"));") > 0);
    }
   public void testT3_30() throws Exception {
        String result = execute("${itemFor.index%2}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"%\",U.p(U.v($context,\"itemFor\"),\"index\"),2));") > 0);
    }
    ...
    public void testT2_2() throws Exception {
        ...
        assertTrue(result.indexOf("getTemplateEngine().renderTemplate(U.getPath(getPath(),\"aaa/bb/cc/dd\"),$newContext,outputStream);") > 0);
    ...
    public void testT2_4() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,\"<a>b</c>\");") > 0);
    }

    public void testT3() throws Exception {
        String result = execute("a#--abc--#b");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,\"a\");") > 0);
        assertTrue(result.indexOf("write(outputStream,\"b\");") > 0);
    }

    public void testT3_1() throws Exception {
        String result = execute("${-123}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"l-\",123));") > 0);
    }

    public void testT3_2() throws Exception {
        String result = execute("${'abc\"def'}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,\"abc\\\"def\");") > 0);
    }
    ...
    public void testT3_4() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"==\",1,2));") > 0);
    }
    ...
    public void testT3_5() throws Exception {
        ...
        assertTrue(result.indexOf("write(outputStream,\"aaa\");") > 0);
    }
    ...
    public void testT3_6() throws Exception {
        ...
        assertTrue(result.indexOf("if(U.b(true)){") > 0);
        assertTrue(result.indexOf("write(outputStream,\"aaa\");") > 0);
        assertTrue(result.indexOf("write(outputStream,\"bbb\");") > 0);
    }
    ...
    public void testT4_2() throws Exception {
        ...
        assertTrue(result.indexOf("write(outputStream,\"ab\");") > 0);
    }

    public void testT5() throws Exception {
        String result = execute("##abc");
        System.out.println(result);
        assertTrue(result.indexOf("outputStream.write") < 0);
    }

    public void testT6() throws Exception {
        String result = execute("${123}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,123);") > 0);
    }
    ...
    public void testT11() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.p(U.v($context,\"a\"),\"b\"));") > 0);
    }

    public void testT12() throws Exception {
        String result = execute("${a+1}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"+\",U.v($context,\"a\"),1));") > 0);
    }

    public void testT13() throws Exception {
        String result = execute("${a[1]}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.a(U.v($context,\"a\"),1));") > 0);
    }

    public void testT14() throws Exception {
        String result = execute("${a[$b]}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.a(U.v($context,\"a\"),U.v($context,\"b\")));") > 0);
    }

    public void testT15() throws Exception {
        String result = execute("${a+b}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"+\",U.v($context,\"a\"),U.v($context,\"b\")));") > 0);
    }
    ...
    public void testT17() throws Exception {
        String result = execute("$!{\"<abc\"}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.escapeHtml((\"<abc\")));") > 0);
    }
    ...
    public void testT21() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,getTemplateEngine().executeFunction(\"a\",O.e(\"+\",U.v($context,\"b\"),1)));") > 0);
    }
    ...
    public void testT27() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"==\",1,O.e(\"*\",2,3)));") > 0);
    }

    public void testT28() throws Exception {
        String result = execute("${aa==2*3}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"==\",U.v($context,\"aa\"),O.e(\"*\",2,3)));") > 0);
    }
    ...
    public void testT30_1() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.c($template,U.v($context,\"aa\"),\"bb\",1,2,U.v($context,\"bb\")));") > 0);
    }
    ...
    public void testT31() throws Exception {
        ...
        assertTrue(result.indexOf("write(outputStream,\"abc\");") > 0);
        assertTrue(result.indexOf("write(outputStream,\"def\");") > 0);
    }
    ...
    public void testT36() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.b(true)||U.b(false));") > 0);
    }
    ...
    public void testT37() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.b(true)?1:2);") > 0);
    }
    ...
    public void testT39() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"|\",O.e(\"|\",4,6),6));") > 0);
    }

    public void testT40() throws Exception {
        String result = execute("${4+6+6^3|3}");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,O.e(\"|\",O.e(\"^\",O.e(\"+\",O.e(\"+\",4,6),6),3),3));") > 0);
    }
    ...
    public void testT42() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.b(U.v($context,\"a\"))?1:2);") > 0);
    }
    ...
    public void testT43_1() throws Exception {
        ...
        assertTrue(result.indexOf(" protected void renderTemplate(TemplateContext $context, OutputStream outputStream) throws IOException, TemplateException{") > 0);
        assertTrue(result.indexOf("write(outputStream,\"abc \");") > 0);
    }
    ...
    public void testT46() throws Exception {
        ...
        assertTrue(result.indexOf("$macro.render($template,$newContext,outputStream);") > 0);
    }
    ...
    public void testT51() throws Exception {
        ...
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.p(U.p(U.v($context,\"a1\"),\"b\"),\"v\"));") > 0);
    }

    public void testT52() throws Exception {
        String result = execute("#macro aab()aa : ${aa}#end");
        System.out.println(result);
        assertTrue(result.indexOf("write(outputStream,U.v($context,\"aa\"));") > 0);
    }
}
