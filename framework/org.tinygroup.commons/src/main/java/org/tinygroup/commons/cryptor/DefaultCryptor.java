...
public class DefaultCryptor implements Cryptor
{
    ...
    public String encrypt(String plainKey,String seed) throws Exception
    {
        ...
        SecretKeySpec key = new SecretKeySpec(getSeedBytes(seed), "AES");
     ...
     * @throws Exception If an error occurs.
     */
    public String decrypt(String encryptedKey,String seed) throws Exception
    {
	...
	private byte[] getSeedBytes(String seed) {
		byte[] keys=new byte[KEY_BYTES.length];
        if(seed!=null){
