...
import org.tinygroup.cepcorepcsc.impl.ServicePcEventProcessor;
...
public class ArWorker implements Worker {
	...
	private ArOperator arOperator;

	public ArWorker(String id, ArOperator arOperator) {
		this.id = id;
	...
	public Warehouse dealUnReg(Work work) {
		...
		EventProcessor unregProcessor = eventprocessors.remove(unregNode
				.getNodeName());
