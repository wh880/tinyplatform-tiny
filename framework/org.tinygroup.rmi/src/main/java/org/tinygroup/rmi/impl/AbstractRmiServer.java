...
public abstract class AbstractRmiServer extends UnicastRemoteObject implements RmiServer,Runnable {
	...
	ConcurrentLinkedQueue<RemoteObjectDescription> regQueue = new ConcurrentLinkedQueue<RemoteObjectDescription>();
...
//		regThread.start();
	...
	public void registerRemoteObject(Remote object, String name)  throws RemoteException{
		...
		RemoteObjectDescription o = new RemoteObjectDescription(object, name);
		synchronized (this) {
			regQueue.add(o);
			this.notify();
		}
