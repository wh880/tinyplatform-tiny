 ...
 * 
 */
public abstract class AbstractQueryBeanNoneValue implements QueryBean {
	...
	public AbstractQueryBeanNoneValue(String propertyName, String compareMode) {
		this.propertyName = propertyName;
		this.compareMode = compareMode;
	}
	...
	private void checkCompareMode() {
		if (propertyName == null || compareMode == null) {
			throw new TinyDbRuntimeException("无效的QueryBean，类型"
