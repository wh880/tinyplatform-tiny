...
public class ResultSetMetaDataTest extends TestCase {
	...
	public void testTableNameWithDiffSchema() throws ClassNotFoundException,
			SQLException {
		Connection connection = getConnectionWithDiffSchema();
		Statement stmt = connection.createStatement();
		for (int i = 0; i < 100; i++) {
			String sql = "select * from aaa where id=" + (i + 1)
					+ " order by id";
	...
	public void testTableNameWithSomeSchema() throws ClassNotFoundException,
			SQLException {
