...
public class CopyOfShardedJedisSentinelPool extends Pool<ShardedJedis> {
    ...
    public CopyOfShardedJedisSentinelPool(List<String> masters, Set<String> sentinels) {
		this(masters, sentinels, new GenericObjectPoolConfig(),
			Protocol.DEFAULT_TIMEOUT, null, Protocol.DEFAULT_DATABASE);
    }
    
    public CopyOfShardedJedisSentinelPool(List<String> masters, Set<String> sentinels, String password) {
		this(masters, sentinels, new GenericObjectPoolConfig(),
			Protocol.DEFAULT_TIMEOUT, password);
    }
    
    public CopyOfShardedJedisSentinelPool(final GenericObjectPoolConfig poolConfig, List<String> masters, Set<String> sentinels) {
    ...
    public CopyOfShardedJedisSentinelPool(Map<String, Map<String, ShardSentinelConfig>> map){
    	if(map.size()==0){
    		throw new RuntimeException("redis配置为空");
    	}
    	for(String sentinels:map.keySet()){
    		Map<String, ShardSentinelConfig> shardSentinelConfigConfig = map.get(sentinels);
    	}
    }
    private void initSentinels(String sentinels,Map<String, ShardSentinelConfig> map){
